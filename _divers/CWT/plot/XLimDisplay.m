    ...
    methods
        ...
        function addAxesXLim(obj, Axes, updateLimAxes)
            ...
            for k_ax = 1:length(Axes)
                ...
                obj.XminLines(end+1) = xline(ax, XLimDisplay.infTo0(obj.XLim(1)), '-', 'Tmin',...
                    'LabelHorizontalAlignment', 'left', 'LabelOrientation', 'horizontal',...
                    'Visible', obj.XLimVisible && isfinite(obj.XLim(1)));
                obj.XmaxLines(end+1) = xline(ax, XLimDisplay.infTo0(obj.XLim(2)), '-', 'Tmax',...
        ...
        function addAxesXLimRidges(obj, Axes, updateLimAxes)
            ...
            for k_ax = 1:length(Axes)
                ...
                obj.XminRidgesLines(end+1) = xline(ax, XLimDisplay.infTo0(obj.XLimRidges(1)), '--',...
                    {'', 'Tmin ridges'}, 'LabelHorizontalAlignment', 'left', 'LabelOrientation', 'horizontal',...
                ...
                obj.XmaxRidgesLines(end+1) = xline(ax, XLimDisplay.infTo0(obj.XLimRidges(2)), '--',...
                    {'', 'Tmax ridges'}, 'LabelHorizontalAlignment', 'right', 'LabelOrientation', 'horizontal',...
