...
nT = 5;
    ...
    function [A1, A2] = ridgesAprox(mu, w0, w1, epsilon, alpha, x0, v0, t01, t02)
        % paramètres
        Om1 = w0;
        Om2 = w1;
...
%         Pv0 = Param(6:7);
        ...
        [A1, A2] = ridgesAprox(Pmu, Om1t, Om2t, Pepsilon, Palpha, Px0, Pv0, t01, t02);
        deltax = [A1 - At1, A2 - At2];
    end


    function deltax = S2(Param)
        Pmu = 0.01;
        Pepsilon = Param(1);
        Palpha = Param(2);
        Px0 = Xi;
...
Param0 = [0.1, 0.1, 2, 0, 0, 2, 0]; %mu, epsilon, alpha, x01, x02, v01, v02
...
Param1 = lsqnonlin(@S1, Param0);%, lb, ub, optionsReg);

Param2 = lsqnonlin(@S2, Param0);%, lb, ub, optionsReg);
