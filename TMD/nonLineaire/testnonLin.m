...
fun = @(t, angles) [angles(3); angles(4);...
    1i*(omega0^2-angles(3)^2-mu*omega1^2*exp(1i*(angles(2)-angles(1))));...
    1i*((1+mu)*omega1^2-angles(4)^2-omega0^2*exp(1i*(angles(1)-angles(2))))];
angles0 = [1i*log(omega0) ; 1i*log(omega1)-pi; omega0; omega1];
