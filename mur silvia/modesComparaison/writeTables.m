...
docStringFreq = [docStringFreq, '\begin{tabular}[c]{@{}c@{}}Frequency\\ (LMS)\\ Hz \end{tabular} & ', newline];
...
docStringDamp = [docStringDamp, '\begin{tabular}[c]{@{}c@{}}Damping\\ (LMS)\\ \% \end{tabular} & ', newline];
...
docStringShape = [docStringShape, '\begin{tabular}[c]{@{}c@{}}MAC\\ (CWT\\ $\times$ LMS)\\ \% \end{tabular} & ', newline];
docStringShape = [docStringShape, '\begin{tabular}[c]{@{}c@{}}MAC\\ (CWT2\\ $\times$ LMS)\\ \% \end{tabular} & ', newline];
docStringShape = [docStringShape, '\begin{tabular}[c]{@{}c@{}}MAC\\ (CWT2\\ $\times$ CWT)\\ \% \end{tabular} & ', newline];
docStringShape = [docStringShape, '\begin{tabular}[c]{@{}c@{}}$\tilde I_{np}$\\ (LMS)\\ \% \end{tabular} & ', newline];
