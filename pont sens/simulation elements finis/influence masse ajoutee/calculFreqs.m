...
enregistrement = true;
saveFile = 'pont sens/simulation elements finis/influence masse ajoutee/results';
...
for kSimul = 1:18
    ...
    fig_wvlt = WaveletMenu('WaveletPlot', plt, 'fmin', fmin, 'fmax', fmax, 'Q', Q,...
        'MaxRidges', MaxRidges, 'XLim', XLim, 'RemoveMean', true, 'CtEdgeEffects', ct);
    ...
    Array_zeta = [Array_zeta, zeta];
    Array_zeta_t = [Array_zeta_t, zeta_t];
...
if enregistrement
    save(saveFile, 'Array_Fn', 'Array_Fn_t', 'Array_mu', 'Array_Lw', 'Array_zeta', 'Array_zeta_t');
end